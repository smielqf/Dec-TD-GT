    ...
    def reset_world(self, world):
        ...
        for i, landmark in enumerate(world.landmarks):
            if i == 0:
                ...
                landmark.state.p_pos = np.random.uniform(-0.25, -0.25, world.dim_p)
            elif i == 5:
                landmark.state.p_pos = np.random.uniform(0.25, 0.25, world.dim_p)
            elif i == 6:
                landmark.state.p_pos = np.random.uniform(0.5, 0.5, world.dim_p)
                ...
                landmark.state.p_pos = np.random.uniform(0.5, 0.25, world.dim_p)
            elif i == 16:
                landmark.state.p_pos = np.random.uniform(0.5, -0.25, world.dim_p)
            elif i == 17:
                landmark.state.p_pos = np.random.uniform(0.75, 0.25, world.dim_p)
            else:
